...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="{{ URL('assets/css/intro.css') }}">
      ...
      <div class="iq-sidebar  sidebar-default ">
          <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
              <a href="/" class="header-logo">
                  <img src="{{ URL('assets/images/logo.png') }}" class="img-fluid rounded-normal light-logo" alt="logo"><h5 class="logo-title light-logo ml-3">POSDash</h5>
              </a>
              ...
              <nav class="iq-sidebar-menu">
                            ...
                            <ul id="banner" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                    <li class="">
                                            <a href="{{ route('admin.banner.index') }}">
                                                <i class="las la-minus"></i><span>List Banner</span>
                                            </a>
                                    </li>
                                    <li class="">
                                            <a href="{{ route('admin.banner.create') }}">
                                                <i class="las la-minus"></i><span>Add Banner</span>
                                            </a>
                                    </li>
                            </ul>
                        </li>
                ...
                @else
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        <li class="">
                            <a href="{{ route('user.order.index') }}" class="collapsed">
                                <svg class="svg-icon" id="p-dash2" width="20" height="20"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle>
                                    <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path>
                                </svg>
                                <span class="ml-4">Orders</span>                              
                  ...
                  <div class="card border-none">
                      <div class="card-body p-0">
                          <div class="sidebarbottom-content">
                              <div class="image"><img src="{{ URL('assets/images/layouts/side-bkg.png') }}" class="img-fluid" alt="side-bkg"></div>
              ...
              <nav class="navbar navbar-expand-lg navbar-light p-0">
                  <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                      ...
                      <a href="../backend/index.html" class="header-logo">
                          <img src="{{ URL('assets/images/logo.png') }}" class="img-fluid rounded-normal" alt="logo">
                          ...
                          <ul class="navbar-nav ml-auto navbar-list align-items-center">
                              <li class="nav-item nav-icon dropdown">
                                  <a href="#" class="search-toggle dropdown-toggle btn border add-btn"
                                      ...
                                      aria-expanded="false">
                                      <img src="{{ URL('assets/images/small/flag-01.png') }}" alt="img-flag"
                                      ...
                                      <div class="card shadow-none m-0">
                                          <div class="card-body p-3">
                                              <a class="iq-sub-card" href="#"><img
                                                      src="{{ URL('assets/images/small/flag-02.png') }}" alt="img-flag"
                                                      class="img-fluid mr-2">French</a>
                                              <a class="iq-sub-card" href="#"><img
                                                      src="{{ URL('assets/images/small/flag-03.png') }}" alt="img-flag"
                                                      class="img-fluid mr-2">Spanish</a>
                                              <a class="iq-sub-card" href="#"><img
                                                      src="{{ URL('assets/images/small/flag-04.png') }}" alt="img-flag"
                                                      class="img-fluid mr-2">Italian</a>
                                              <a class="iq-sub-card" href="#"><img
                                                      src="{{ URL('assets/images/small/flag-05.png') }}" alt="img-flag"
                                                      class="img-fluid mr-2">German</a>
                                              <a class="iq-sub-card" href="#"><img
                                                      src="{{ URL('assets/images/small/flag-06.png') }}" alt="img-flag"
                              ...
                              <li class="nav-item nav-icon dropdown caption-content">
                                  <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton4"
                                      data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      <img src="{{ URL('assets/images/user/1.png') }}" class="img-fluid rounded" alt="user">
                                  </a>
                                  <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <div class="card shadow-none m-0">
                                          <div class="card-body p-0 text-center">
                                              <div class="media-body profile-detail text-center">
                                                  <img src="{{ URL('assets/images/page-img/profile-bg.jpg') }}" alt="profile-bg"
                                                      class="rounded-top img-fluid mb-4">
                                                  <img src="{{ URL('assets/images/user/1.png') }}" alt="profile-img"
                                                      class="rounded profile-img img-fluid avatar-70">
                                              </div>
                                              <div class="p-3">
                                                  <h5 class="mb-1">{{ Auth::user()->email }}</h5>
                                                  <p class="mb-0">{{ now('Asia/Ho_Chi_Minh')->toDateString() }}</p>
                                                  <div class="d-flex align-items-center justify-content-center mt-3">
                                                      <a href="{{ route('profile.edit') }}" class="btn border mr-2">Profile</a>
                                                      <form method="POST" action="{{ route('logout') }}">
                                                        @csrf
                                                        <a href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();" class="btn border">Sign Out</a>
                                                    </form>
